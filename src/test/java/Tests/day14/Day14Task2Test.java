...
//    @Test
//    void normal() {
//        File file = new File("src/people.txt/resources/D14T2_1.txt");
...
//    @Test
//    void negativeAge() {
//        File file = new File("src/people.txt/resources/D14T2_2.txt");
...
//    @Test
//    void fileNotFound() {
//        File file = new File("src/people.txt/resources/D14T2_miss.txt");
//        Task2.parseFileToStringList(file);
